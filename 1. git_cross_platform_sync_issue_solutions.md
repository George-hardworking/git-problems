...
git diff --check  # Check for whitespace/line ending issues

# Use correct commit workflow
git add .
git commit -m "message"
git pull --rebase origin main  # Rebase before pushing
...
## 📅 问题概述
**日期**：2025年10月15日  
**涉及系统**：Mac (本地主力)、Windows (备用)、Linux (实验室服务器)  
